...
public class ElectronicTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        electronicPage.changeQuantity();
        Thread.sleep(1000);

        //2.9 Click on “ADD TO CART” tab
        electronicPage.setAddToCartNokiaLumiaPhone();
        Thread.sleep(1000);
        ...
        Assert.assertEquals(electronicPage.getShoppingCartText(),"Shopping cart","Shopping cart not displayed successfully");
        Thread.sleep(2000);
        ...
        Assert.assertEquals(electronicPage.verifyWelcomeText(),"Register","Navigation not successful");
        ...
        registerPage.enterPassword("James123");
        registerPage.enterConfirmPassword("James123");
        ...
        loginPage.enterPassword("James123");
        loginPage.clickOnLoginButton();
        shoppingCartPage.termsAndCondition();
        shoppingCartPage.goCheckout();
        billingPage.selectCountry("United Kingdom");
        billingPage.enterCity("Liverpool");
        billingPage.enterAddress("20, Ring rd");
        billingPage.enterPostcode("NY50HR");
        billingPage.enterPhoneNumber("37657896541230");
